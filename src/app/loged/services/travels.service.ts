...
export class TravelsService {
  ...
  getAllAvilableRetiro(): Observable<Viaje[]> {
    return this.http.get<Viaje[]>(
      `http://logistica.asambleas.cl/api/Travel/2/1`
    );
  }
  getAllAvilableEntrega(): Observable<Viaje[]> {
    return this.http.get<Viaje[]>(
      `http://logistica.asambleas.cl/api/Travel/2/5`
    );
  }
  ...
  getAllAvilableRetiroAsignado(): Observable<Viaje[]> {
    return this.http.get<Viaje[]>(
      `http://logistica.asambleas.cl/api/Travel/2/2`
    );
  }
  getAllAvilableEntregaAsignado(): Observable<Viaje[]> {
    return this.http.get<Viaje[]>(
      `http://logistica.asambleas.cl/api/Travel/2/6`
    );
  }
  ...
  getAllAvilableRetiroEnCurso(): Observable<Viaje[]> {
    return this.http.get<Viaje[]>(
      `http://logistica.asambleas.cl/api/Travel/2/3`
    );
  }
  getAllAvilableEntregaEnCurso(): Observable<Viaje[]> {
    return this.http.get<Viaje[]>(
      `http://logistica.asambleas.cl/api/Travel/2/7`
    );
  }
  ...
  adquirirViaje(viaje: Viaje, cadeteId: number): Observable<Viaje> {
    return this.http.post<Viaje>(
      `http://logistica.asambleas.cl/api/Travel?travelId=${
        viaje.id
      }&statusTravel=${
  ...
  getAllEntregadosRetiro(): Observable<Viaje[]> {
    return this.http.get<Viaje[]>(
      `http://logistica.asambleas.cl/api/Travel/2/4`
    );
  }
  getAllEntregadosEntrega(): Observable<Viaje[]> {
    return this.http.get<Viaje[]>(
      `http://logistica.asambleas.cl/api/Travel/2/8`
    );
  }
}
